...
function create(name, species, genderIndex, primaryColor, hairStyle, secondaryColor, leafStyle, markingsColor, markingsPattern, eyeColor, _8, personality, bellyColor, hairColor, ...)
	...
	local parameters = {
		choices = { genderIndex, primaryColor, hairStyle, secondaryColor, leafStyle, markingsColor, markingsPattern, eyeColor, _8, personality, ... },
		--this you can do a lot with, see the humanoid build script
		identityTags = {
			leafType = speciesConfig.leafStyle[leafStyle+1]
		}
	}
	local armor = {
		head = nil,
